...
export default function ThemeProvider({ children }) {
  const [theme, setTheme] = useState(() => localStorage.getItem("releaf_theme") || "ocean");
  const [dark, setDark] = useState(() => localStorage.getItem("releaf_dark") === "true");

  useEffect(() => {
    localStorage.setItem("releaf_theme", theme);
    localStorage.setItem("releaf_dark", String(dark));
